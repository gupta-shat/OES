                      ...
                      <form>
                          <div class="row">
                            <div class="form-group col-lg-6 col-sm-12">
                                ...
                                <input id="Subject" type="text" class="form-control" name="Session" required="">
                            </div>
                            <div class="form-group col-lg-6 col-sm-12">
                                <span class=" ">Period:</span>
                                <input id="Course" type="text" class="form-control" name="Period" required="">
                            </div>
                          </div>
                          <div class="row">
                            <div class="form-group col-lg-6 col-sm-12">
                            ...
                            <div class="form-group col-lg-6 col-sm-12">
                               ...
                               <input id="Faculty" type="text" class="form-control" name="Academic Year" required="">
                                </div>
                            </div>
                          </div>
